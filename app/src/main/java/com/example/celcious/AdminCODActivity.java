...
public class AdminCODActivity extends AppCompatActivity {
    ...
    RecyclerView CODRecyclerView;
    AdminCODRecViewAdapter CODActivityAdapter;
    ArrayList<Admin> admins_list;
    DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference();
    DatabaseReference databaseReference = rootRef.child("CODShipments");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_codactivity);
        ...
        noData = findViewById(R.id.no_item_in_cod_text);
        noData.setVisibility(View.INVISIBLE);

        meetUpButton = findViewById(R.id.meet_up_activity);

        CODRecyclerView = findViewById(R.id.cod_recycler_view);
        CODRecyclerView.setHasFixedSize(true);
        admins_list = new ArrayList<>();

        CODActivityAdapter = new AdminCODRecViewAdapter(this);
        CODActivityAdapter.setAdmins(admins_list);
        CODRecyclerView.setAdapter(CODActivityAdapter);
        CODRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(CODActivityAdapter.getItemCount() == 0){
                    noData.setVisibility(View.VISIBLE);
                }
                CODActivityAdapter.notifyDataSetChanged();
            }
        ...
        //For swipe refresh
        refreshLayout = findViewById(R.id.refresh_admin_cod);
